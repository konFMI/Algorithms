...
namespace Algorithms
{
	...
	namespace Sorting
	{
		...
		template<typename TypeKey, typename TypeValue>
		void Sort<TypeKey, OTypeValue>::SelectionSort(std::vector<int>& collection)
		{
		...
		template<typename TypeKey, typename TypeValue>
		void Sort<TypeKey, TypeValue>::BubbleSort(std::vector<int>& collection)
		{
			size_t length = collection.size();
			/*bool notSorted = true;
			while (notSorted)
		...
		template<typename TypeKey, typename TypeValue>
		void Sort<TypeKey, TypeValue>::ShakeSort(std::vector<Element<TypeKey, TypeValue>>& collection)
		{
		...
		template<typename TypeKey, typename TypeValue>
		void Sort<TypeKey, TypeValue>::MergeSort(std::vector<int>& collection, int left, int right)
		{
			if (left < right)
			{
		...
		template<typename TypeKey, typename TypeValue>
		void Sort<TypeKey,TypeValue>::Merge(std::vector<int>& collection, int left, int middle, int right)
		{
			int i = 0, j = 0, k = 0;
		...
		template<typename TypeKey, typename TypeValue>
		void Sort< TypeKey, TypeValue>::MaxHeapify(std::vector<Element<TypeKey,TypeValue>>& collection, int length, int index)
		{
			int largest = index;
		...
		template<typename TypeKey, typename TypeValue>
		void Sort<TypeKey,TypeValue>::Swap(int& leftValue, int& rightValue)
		{
